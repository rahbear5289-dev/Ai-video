...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Northlight" },
      { name: "description", content: "A launch platform that turns the wait into the moment." },
      { name: "author", content: "Northlight" },
      { property: "og:title", content: "Northlight" },
      { property: "og:description", content: "A launch platform that turns the wait into the moment." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@northlight" },
    ],
    links: [
      {
        rel: "stylesheet",
